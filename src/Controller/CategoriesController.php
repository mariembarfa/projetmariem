...
class CategoriesController extends AbstractController
{
    ...
    // DOSENT WORK
    /**
     * @Route("/events/", name="categories_show", methods={"GET"})
     */
    public function show(EvenementsRepository  $evenementsRepository, Request $request): Response
    {
        $title = $request ->query->get('title');
      //  $category = $evenementsRepository->findByCategory($title);
      //  $category = $evenementsRepository->findBy(array('categorie'=> $title));
/*var_dump($category);
die();*/
